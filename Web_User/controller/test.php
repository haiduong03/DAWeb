...
if (!isset($_SESSION['user_name']) || empty($_SESSION['user_name'])) {
    echo 'Vui lòng Đăng nhập trước khi Thanh toán! <a href="signin.php">Click vào đây để đến trang Đăng nhập</a>';
    die;
} else {
    // Nếu giỏ hàng trong session rỗng, return
    if (!isset($_SESSION['cart_item']) || empty($_SESSION['giohangdata'])) {
